...
class MetricLearningModel(nn.Module):
    def __init__(self, input_dim, hidden_dim, dropout_p=0.2, aplha=0.5, lambda1=0.5, lambda2=0.001, num_layers=1):
        ...
        # weights = torch.tensor([1.0, 6658/1658])
        # weights = torch.tensor([1.0, 16311/6311])
        # weights = torch.tensor([1.0, 11012/9744])
        # self.loss_function = nn.NLLLoss(weight=weights, reduction='none')
