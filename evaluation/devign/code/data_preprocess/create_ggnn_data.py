...
def create_ggnn_data_main(project):
    csv=f'./data/{project}/parsed/'
    src=f'./data/{project}/raw_code/'
    wv='./data/gen_test/raw_code_gen_test.100'#100维
    output=f'./data/output/{project}/'
    os.makedirs(output, exist_ok=True)
    output += f'{project}.json'
    json_file_path = './data/' + project + '_full_data_with_slices.json'
